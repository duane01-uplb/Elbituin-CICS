  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.right}>
        {/* Spending history chart (CSS-based bar chart) */}
...
// Fallback mock data
const MOCK_WALLET = {
  user: { name: "Juan dela Cruz", vehicle: "Tricycle", member_since: "2024-01-15", cooperative: "Batangas Tri-Coop Federation" },
  this_month: { fuel_spend: 6840, trips: 124, liters_consumed: 126, avg_price_paid: 54.29, cheapest_available: 53.20 },
  savings: { this_month: 1360, last_month: 1180, total_lifetime: 14520, co2_avoided_kg: 42, trees_equivalent: 2 },
  wallet: { balance: 4250, cooperative_pool: 185400, coop_members: 312, next_bulk_purchase_date: "2024-02-01", projected_savings_next_month: 1500 },
  history: [
